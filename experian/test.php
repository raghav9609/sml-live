                        ...
                        <tr>
                            ...
                            <td width="33.33%">
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td style="color: #008db1;font-weight: 600;padding: 5px">Last 7 days credit enquiries</td><td width="25%">'.$returnResponse['TotalCAPS_Summary']['CAPSLast7Days'].'</td>
                                    </tr>
                                    <tr>
                                        <td style="color: #008db1;font-weight: 600;padding: 5px">Last 30 days credit enquiries</td><td width="25%">'.$returnResponse['TotalCAPS_Summary']['CAPSLast30Days'].'</td>
                                    </tr>
                                    <tr>
                                        <td style="color: #008db1;font-weight: 600;padding: 5px">Last 90 days credit enquiries</td><td width="25%">'.$returnResponse['TotalCAPS_Summary']['CAPSLast90Days'].'</td>
                                    </tr>
                                    <tr>
                                        <td style="color: #008db1;font-weight: 600;padding: 5px">Last 180 days credit enquiries</td><td width="25%">'.$returnResponse['TotalCAPS_Summary']['CAPSLast180Days'].'</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
