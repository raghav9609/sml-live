...
$getbureaudetails = mysqli_query($Conn1,"Select * from crm_experian_data where query_id = '".$query_id."'");
    ...
    if($bureauData != ''){
       ...
       // echo html_entity_decode($dispBureauData);
         ...
         echo "<br> ANU ".$xmldata = simplexml_load_string(html_entity_decode($dispBureauData));
