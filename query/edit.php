        ...
        <div style="width:100%;"><div style="padding-left: 1%;padding-right: 1%;margin-top:10px;">
            <div id="fixed_tab">
                <span style="font-weight:bold;font-size:14px;">
                    ...
                    <a target="_blank" href="<?php $head_url; ?>/experian/view.php?query_id=<?php echo base64_encode($id);?>"><input type="button" style='background: #1b8c1b;' class="buttonsub cursor" value="View Experian"></a>
                    <?php } ?>
                    <?php if($user_role != 1) { ?>
                                ...
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        $.ajax({
                                            type: "POST",
                                            dataType: "text",
                                            data: "type="+type+"&query_id="+query_id+"&otp="+btoa(result.value)+"&stgOneHitId="+btoa(obj.stgOneHitId)+"&stgTwoHitId="+btoa(obj.stgTwoHitId),
                                            cache: false,
